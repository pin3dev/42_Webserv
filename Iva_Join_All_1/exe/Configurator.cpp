...
/*   Updated: 2024/05/15 22:39:38 by pin3dev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Configurator.hpp"

//addrinfo Configurator::_settings = {}; //** ANTES ERA STATIC E DEPOIS DE UM TEMPO DEU PROBLEMA
...
void Configurator::setSocketToVServer()
{
    ...
    this->_assignAddr();
    this->_setPassive();
    //this->_freeTmpAddr(); // ** TESTAR - VER SE DÁ PROBLEMA SE EU LIMPAR A MEMÓRIIA AQUI
}
...
// ** TESTAR - VER SE DÁ PROBLEMA SE EU LIMPAR A MEMÓRIIA AQUI
